...
interface AddDealFormProps {
  ...
  onProductSelectionChange?: (product: DealDropdownProduct | null) => void;
  onVariationSelectionChange?: (
    variation: DealDropdownVariation | null,
  ) => void;
            ...
            <div className="space-y-4">
              ...
              <ProductAsyncSelect
                ...
                onProductChange={(product) => {
                  ...
                  onVariationSelectionChange?.(null);
              ...
              <VariationAsyncSelect
                ...
                onVariationChange={(variation) => {
                  if (!variation) return;
                  onVariationSelectionChange?.(variation);
                  setFieldValue('variation', variation.id);
                }}
              />
