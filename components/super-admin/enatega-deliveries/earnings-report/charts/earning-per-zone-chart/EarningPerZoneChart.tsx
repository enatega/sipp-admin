...
import { ZoneWiseEarning } from '@/types';
import {
  BarElement,
  CategoryScale,
  Chart as ChartJS,
...
export const EarningsPerZoneChart: React.FC<IEarningsPerZone> = ({
  ...
  const t = useTranslations('lumiFood.earningsReports.charts.earningsPerZone');
  const tTooltip = useTranslations(
    'lumiFood.earningsReports.charts.earningsPerZone.tooltip',
  );
