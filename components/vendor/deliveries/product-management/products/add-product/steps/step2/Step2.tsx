...
import { useCreateProduct } from '@/hooks/api/vendor/deliveries/product-management/products';
...
export const Step2Form: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      resetForm();
      await router.push(getVendorPath(storeId, '/product-management/products'));
    } catch (error) {
